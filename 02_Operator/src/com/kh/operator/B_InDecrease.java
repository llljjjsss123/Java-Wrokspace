...
public class  B_InDecrease {	
	...
	public void method1() {
		...
		//10에서 증감연산을 먼저 11로 num 값을 증가시키고 
		//최종적으로 11이 출력됨
		System.out.println("2회 수행후 결과 : "+ ++num);
		//현재 num=11이 담겨있음. 따라서 12가출력됨
		System.out.println("3회 수행후 결과 : "+ ++num);
		//현재 num=12이 담겨있음. 따라서 13이출력됨
		...
		public void method3() {
			...
			int num2= 20;
			int result2= ++num2*3;//num2=num2+1연산 후 result2=21*3
		...
		public void method4() {
			...
			System.out.println((++a)+(b++));//출력:12+20=30 a:12, b:21, c:30
			System.out.println((a++)+(--b)+(--c));//출력:12+20+29=61 a:12, b:20, c:30
			System.out.println("a:"+a+",  b:"+b+ ",  c:"+ c);//a=13b=20c=29
		...
		public void quiz() {
			int a=5;
			int b=10;
			int c=(++a) +b;//a=6, b=10 c=10+6=16
			int d=c/a;//c=16 a=6 d=16/6=2
			int e= c%a;//c=16 a=6 e=16%6=4
			
			int f= e++;//현재 f=4 나중에 +1 e=4 나중에 +1
			int g=(--b)+(d--);//--b=9 d--=2  g=9+2=11 d=나중에 -1
			int h=2;
